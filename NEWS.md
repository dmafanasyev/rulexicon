...
* `key_economic_tochka_bank`        - Economic Terms Dictionary of Tochka Bank
...
## New Features
This is the first release of rulexicon package that contains following Russian lexicons, polarity tables, lemmatization tables and etc.:
