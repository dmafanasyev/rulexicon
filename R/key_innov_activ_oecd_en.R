...
#'  Table contains \Sexpr{nrow(rulexicon::key_innov_activ_oecd_en)} words and phrases.
#'
#' @docType data
#' @name key_innov_activ_oecd_en
#' @usage data(key_innov_activ_oecd_en)
#' @keywords datasets
#'
#' @format A data frame with \Sexpr{nrow(rulexicon::key_innov_activ_oecd_en)} rows
#' and \Sexpr{ncol(rulexicon::key_innov_activ_oecd_en)} variables:
#' \describe{
...
#'
#' @section Languages:
#' Russian: \code{\link{key_innov_activ_oecd}}
#'
#' @section License:
