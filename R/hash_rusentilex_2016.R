#' General Russian Sentiment Lexicon RuSentiLex 2016
#'
#'  The original table of general Russian sentiment lexicon - RuSentiLex, version 2016.
#'  Table contains \Sexpr{nrow(rulexicon::hash_rusentilex_2016)} unique words or phrases, and
#'  \Sexpr{nrow(rulexicon::hash_rusentilex_2016[rulexicon::hash_rusentilex_2016$sentiment != "neutral",])} has non-neutral sentiment scores.
#'
#' @docType data
#' @name hash_rusentilex_2016
#' @usage data(hash_rusentilex_2016)
#' @keywords datasets
#'
#' @details The lexicon contains the following types of sentiment-related words and phrases:
#'  \itemize{
#'    \item general sentiment (opinionated) words from domain-orented Russian sentiment lists vocabularies;
...
#'
#' @format A data table with \Sexpr{nrow(rulexicon::hash_rusentilex_2016)} rows and
#' \Sexpr{ncol(rulexicon::hash_rusentilex_2016)} variables:
#' \describe{
...
#' }
#'
#' @details Based on the RuSentiLex the polarity table with sentiment scores was generated by maintainer of \code{\pkg{rulexicon}} package,
#' see \code{\link{hash_sentiment_rusentilex_2016}}.
#'
#' @section License:
