#' Polarity Table of General Russian Sentiment Lexicon RuSentiLex 2017
#'
#'  The polarity table of filtered general Russian sentiment lexicon - RuSentiLex, version 2017.
#'  Table contains \Sexpr{nrow(rulexicon::hash_sentiment_rusentilex_2017)} words or phrases, and
#'  \Sexpr{nrow(rulexicon::hash_sentiment_rusentilex_2017[rulexicon::hash_sentiment_rusentilex_2017$score !=0,])}
#'  has non-neutral sentiment scores.
#'
#' @docType data
#' @name hash_sentiment_rusentilex_2017
#' @usage data(hash_sentiment_rusentilex_2017)
#' @keywords datasets
#'
...
#'  }
#'  Also some minor mistakes of the original lexicon table was fixed by \pkg{rulexicon} package maintainer.
#'
...
#'
#' @references
#' Description of the original lexicon table of RuSentiLex (version 2017): \code{\link{hash_rusentilex_2017}}
#'
