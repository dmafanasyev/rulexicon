#' Frequencies Table of Russian First Names
#'
...
#' @keywords datasets
#'
#' @details The frequencies table is based on the information on the most popular male and female names among newborns
...
#'    on the single names ("Даниил", "Данила" and "Данил") according to their freaquences.
#' }
#'
